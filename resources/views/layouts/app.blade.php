...
<head>
    ...
    <link href="/ela-admin/css/lib/calendar2/semantic.ui.min.css" rel="stylesheet">
    <link href="/ela-admin/css/lib/calendar2/pignose.calendar.min.css" rel="stylesheet">
    <link href="/ela-admin/css/lib/owl.carousel.min.css" rel="stylesheet"/>
    <link href="/ela-admin/css/lib/owl.theme.default.min.css" rel="stylesheet"/>
        ...
        <nav class="navbar top-navbar navbar-expand-md navbar-light">
            ...
            <div class="navbar-header">
                <a class="navbar-brand" href="index.html">
                    <!-- Logo icon -->
                    <b><img src="/ela-admin/images/logo.png" alt="homepage" class="dark-logo"/></b>
                    <!--End Logo icon -->
                    <!-- Logo text -->
                    <span><img src="ela-admin/images/logo-text.png" alt="homepage" class="dark-logo"/></span>
                </a>
            </div>
            <!-- End Logo -->
                ...
                <ul id="sidebarnav">
                    ...
                    <li><a class="has-arrow" href="#" aria-expanded="false">
                        ...
                        <ul aria-expanded="false" class="collapse">
                            <li><a href="index1.html">Schedules </a></li>
                            <li><a href="index.html">Deliveries </a></li>
                        </ul>
                    </li>
...
<!-- Amchart -->
<script src="/ela-admin/js/lib/morris-chart/raphael-min.js"></script>
<script src="/ela-admin/js/lib/morris-chart/morris.js"></script>
<script src="/ela-admin/js/lib/morris-chart/dashboard1-init.js"></script>


<script src="/ela-admin/js/lib/calendar-2/moment.latest.min.js"></script>
<!-- scripit init-->
<script src="/ela-admin/js/lib/calendar-2/semantic.ui.min.js"></script>
<!-- scripit init-->
<script src="/ela-admin/js/lib/calendar-2/prism.min.js"></script>
<!-- scripit init-->
<script src="/ela-admin/js/lib/calendar-2/pignose.calendar.min.js"></script>
<!-- scripit init-->
<script src="/ela-admin/js/lib/calendar-2/pignose.init.js"></script>

<script src="/ela-admin/js/lib/owl-carousel/owl.carousel.min.js"></script>
<script src="/ela-admin/js/lib/owl-carousel/owl.carousel-init.js"></script>
<script src="/ela-admin/js/scripts.js"></script>
<!-- scripit init-->
