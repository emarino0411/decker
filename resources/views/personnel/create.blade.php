            ...
            <div class="col-lg-6">
                <div class="card card-outline-primary">
                    <div class="card-header">
                        <h4 class="m-b-0 text-white">Create Personnel Record</h4>
                    </div>
                    <div class="card-body">
                        <form action="#">
                            <div class="form-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <small class="form-control-feedback"> Select truck type</small>
                                        </div>
                                    </div>
                                    <!--/span-->
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <small class="form-control-feedback"> Select truck category</small>
                                        </div>
                                    </div>
                                    <!--/span-->
                                </div>
